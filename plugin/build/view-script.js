...
window.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('div.google-maps-gutenberg-block').forEach(element => {
    ...
    (0,_utilities__WEBPACK_IMPORTED_MODULE_0__.getMapObject)(attributes.key, element).then(map => (0,_utilities__WEBPACK_IMPORTED_MODULE_0__.initializeMap)(map, attributes));
  });
});
}();
/******/ })()
